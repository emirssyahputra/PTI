...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url('vendors/mdi/css/materialdesignicons.min.css'); ?>"> <!-- INI WAJIB BUAT BISA MAKE ICON -->
  <!-- endinject -->
